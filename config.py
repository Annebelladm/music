...
MONGO_DB_URI = getenv("MONGO_DB_URI", mongodb+srv://kamalkishor165040:kamalkishor165040@cluster0.wxloo4t.mongodb.net/ )

# Vars For API End Pont.
YTPROXY_URL = getenv("YTPROXY_URL", 'https://tgapi.xbitcode.com') ## xBit Music Endpoint.
YT_API_KEY = getenv("YT_API_KEY" , 'xbit_6Pv279q_F7023HZDVW-p2azEdqDgGupN' ) ## Your API key like: xbit_10000000xx0233 Get from  https://t.me/tgmusic_apibot
